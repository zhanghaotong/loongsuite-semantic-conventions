...
| [`gen_ai.agent.version`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If provided by the application. | string | The version of the GenAI agent. | `1.0.0`; `2025-05-01` |
...
| [`gen_ai.span.kind`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if dialect is alibaba_cloud (default) | string | The type of GenAI operation being performed. [9] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
| [`gen_ai.span_kind_name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if dialect is alibaba_group | string | The type of GenAI operation being performed. [10] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If `server.address` is set. | int | GenAI server port. [11] | `80`; `8080`; `443` |
...
**[9] `gen_ai.span.kind`:** Dedicated GenAI span classification attribute for the `alibaba_cloud` dialect. See the dialect switch documentation in `gen_ai.span.kind` for details.
...
<!-- semconv span.gen_ai.invoke_agent.internal -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- semconv span.gen_ai.invoke_workflow.internal -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
