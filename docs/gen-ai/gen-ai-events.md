...
- [Event: `gen_ai.token.scheduled`](#event-gen_aitokenscheduled)
- [Event: `gen_ai.token.generated`](#event-gen_aitokengenerated)
...
| [`gen_ai.request.trace_level`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The tracing granularity requested or recorded for the inference operation. | `0`; `1`; `2` |
...
| [`gen_ai.iteration.per_token_batch_size`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Batch size for the decode iteration associated with each output token. [14] | `[32, 32, 28]` |
| [`gen_ai.iteration.per_token_total_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Cumulative number of tokens generated by the engine or scheduler for each output token. [15] | `[4096, 4097, 4098]` |
| [`gen_ai.iteration.per_token_waiting_size`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Number of requests waiting in the scheduler queue when each output token was scheduled. [16] | `[120, 98, 105]` |
| [`gen_ai.latency.per_token_generation_time`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | double[] | Relative generation or emission timestamp for each output token. [17] | `[0.0031, 0.0059, 0.0088]` |
| [`gen_ai.latency.per_token_scheduled_time`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | double[] | Relative scheduling timestamp for each output token. [18] | `[0.001, 0.004, 0.007]` |
...
| [`gen_ai.response.per_token_candidate_decoded_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | Candidate decoded token strings for each generated token position. [20] | [<br>&nbsp;&nbsp;["Hello", "Hello", "Hi"],<br>&nbsp;&nbsp;["there", "world", "there"]<br>] |
| [`gen_ai.response.per_token_candidate_token_ids`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | Candidate token identifiers for each generated token position. [21] | [<br>&nbsp;&nbsp;[15043, 15043, 1723],<br>&nbsp;&nbsp;[1052, 995, 1052]<br>] |
| [`gen_ai.response.per_token_candidate_tokens_logprobs`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | Candidate token log probabilities for each generated token position. [22] | [<br>&nbsp;&nbsp;[-1.03, -0.12, -1.03],<br>&nbsp;&nbsp;[-0.05, -0.05, -2.11]<br>] |
| [`gen_ai.response.per_token_num_new_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Number of newly generated tokens associated with each recorded output token position. [23] | `[2, 3, 1]` |
| [`gen_ai.system_instructions`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | The system message or instructions provided to the GenAI model separately from the chat history. [24] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "You are an Agent that greet users, always use greetings tool to respond"<br>&nbsp;&nbsp;}<br>]; [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "You are a language translator."<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "Your mission is to translate text in English to French."<br>&nbsp;&nbsp;}<br>] |
| [`gen_ai.tool.definitions`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | The list of source system tool definitions available to the GenAI agent or model. [25] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "function",<br>&nbsp;&nbsp;&nbsp;&nbsp;"name": "get_current_weather",<br>&nbsp;&nbsp;&nbsp;&nbsp;"description": "Get the current weather in a given location",<br>&nbsp;&nbsp;&nbsp;&nbsp;"parameters": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "object",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"properties": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"location": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"description": "The city and state, e.g. San Francisco, CA"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unit": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"enum": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"celsius",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"fahrenheit"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"required": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"location",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unit"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;}<br>] |
...
**[14] `gen_ai.iteration.per_token_batch_size`:** There SHOULD be one value per generated output token position.

**[15] `gen_ai.iteration.per_token_total_tokens`:** There SHOULD be one value per generated output token position.

**[16] `gen_ai.iteration.per_token_waiting_size`:** There SHOULD be one value per generated output token position.

**[17] `gen_ai.latency.per_token_generation_time`:** The values are relative to the start of the span or request and measured in seconds. There SHOULD be one value per generated output token.

**[18] `gen_ai.latency.per_token_scheduled_time`:** The values are relative to the start of the span or request and measured in seconds. There SHOULD be one value per generated output token.

**[19] `gen_ai.output.messages`:** Instrumentations MUST follow [Output messages JSON schema](/docs/gen-ai/gen-ai-output-messages.json)
...
**[20] `gen_ai.response.per_token_candidate_decoded_tokens`:** It's expected to be an array of arrays where the outer array indexes
...
**[21] `gen_ai.response.per_token_candidate_token_ids`:** It's expected to be an array of arrays where the outer array indexes
the generated token position and the inner array contains candidate
...
**[22] `gen_ai.response.per_token_candidate_tokens_logprobs`:** It's expected to be an array of arrays where the outer array indexes
the generated token position and the inner array contains candidate
...
**[23] `gen_ai.response.per_token_num_new_tokens`:** This attribute is primarily intended for multi-token prediction systems.
...
**[25] `gen_ai.tool.definitions`:** The value of this attribute matches source system tool definition format.
...
## Event: `gen_ai.token.scheduled`

<!-- semconv event.gen_ai.token.scheduled -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
The event name MUST be `gen_ai.token.scheduled`.

This event describes that the request associated with generating an output token has been scheduled by the inference engine.

The event timestamp SHOULD be set to the time when the corresponding decode iteration scheduled the request. Relative scheduling time can be derived from the parent span start time.

**Attributes:**

| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`gen_ai.iteration.batch_size`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The batch size of the decode iteration associated with the event. | `32` |
| [`gen_ai.iteration.waiting_requests`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of requests waiting in the scheduler queue for the decode iteration associated with the event. | `120` |

<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->

## Event: `gen_ai.token.generated`

<!-- semconv event.gen_ai.token.generated -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
The event name MUST be `gen_ai.token.generated`.

This event describes that an output token has been generated or emitted by the inference engine.

The event timestamp SHOULD be set to the time when the output token was generated or emitted. Relative generation time can be derived from the parent span start time.
Instrumentations that emit candidate token details SHOULD order them by rank and place the emitted token first. Systems that generate multiple output tokens in one iteration MAY emit multiple `gen_ai.token.generated` events with the same timestamp.

**Attributes:**

| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`gen_ai.response.candidate.decoded_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if candidate token details are recorded | string[] | Candidate decoded token strings associated with an output token event. [1] | `["Hello", "Hi"]` |
| [`gen_ai.response.candidate.logprobs`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if candidate token log probabilities are recorded | double[] | Log probabilities for candidate tokens associated with an output token event. [2] | `[-0.12, -1.03]` |
| [`gen_ai.response.candidate.token_ids`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if candidate token ids are recorded | int[] | Candidate token identifiers associated with an output token event. [3] | `[15043, 1723]` |
| [`gen_ai.iteration.total_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The cumulative number of tokens generated by the engine or scheduler when the associated token event was recorded. | `4096` |

**[1] `gen_ai.response.candidate.decoded_tokens`:** The values SHOULD be ordered by rank with the emitted token first when it is known.

**[2] `gen_ai.response.candidate.logprobs`:** The values SHOULD align with `gen_ai.response.candidate.decoded_tokens` and `gen_ai.response.candidate.token_ids`.

**[3] `gen_ai.response.candidate.token_ids`:** The values SHOULD align with `gen_ai.response.candidate.decoded_tokens`.
