...
Welcome to LoongSuite semantic conventions repository!

This repository is maintained by Alibaba's Observability Team and contains GenAI-specific semantic conventions that supplement the OpenTelemetry Semantic Conventions.
...
Before you can contribute, you will need to sign the Contributor License Agreement. Please contact the maintainers for details.
...
Semantic conventions in this repository are organized by focus areas with ownership
...
- The conventions align with OpenTelemetry Semantic Conventions principles
